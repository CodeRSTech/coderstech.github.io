...
<div class="py-5 border-bottom border-secondary">
  ...
  <div class="d-flex gap-3 mt-4">
    <a href="mailto:your.email@example.com" class="btn btn-primary"><i class="bi bi-envelope-fill me-2"></i>Contact</a>
    <a href="https://github.com/coderstech" class="btn btn-outline-light"><i class="bi bi-github me-2"></i>GitHub</a>
    <!-- Add LinkedIn or other profiles here -->
  </div>
</div>
...
<!-- Featured Work Routing -->
<div class="py-5">
  <h2 class="mb-4 text-light"><i class="bi bi-journal-code me-2 text-primary"></i>R&D Sectors</h2>
  <div class="row g-4">
    <div class="col-md-6">
...
<div class="py-5 border-bottom border-secondary">
  ...
  <!-- Grid container handles side-by-side on desktop, stacking on mobile -->
  <div class="row g-4">
  ...
  <div class="col-xl-6 col-lg-12">
    <div class="card bg-dark border-secondary overflow-hidden h-100">
      <div class="card-header border-secondary text-white-50 small text-uppercase fw-bold">
        <i class="bi bi-code-slash me-2"></i>HackerEarth
      </div>
      <!-- p-0 removes padding so the iframe sits flush against the card edges -->
      <div class="card-body p-0 bg-black"> 
        <!-- Native Bootstrap responsive ratio wrapper (630 / 1200 = 52.5%) -->
        <div class="ratio" style="--bs-aspect-ratio: 52.5%;">
          <iframe
  ...
  <!-- Future Profile Allocation (e.g., GitHub, Kaggle) -->
  <div class="col-xl-6 col-lg-12">
    <div class="card bg-dark border-secondary overflow-hidden h-100">
      <div class="card-header border-secondary text-white-50 small text-uppercase fw-bold">
        <i class="bi bi-github me-2"></i>GitHub / Next Profile
      </div>
      <div class="card-body p-0 bg-black d-flex align-items-center justify-content-center" style="min-height: 300px;">
        <span class="text-muted small">[ Future Embed Allocation ]</span>
      </div>
    </div>
  </div>
  </div>
